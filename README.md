# Live Chat com Spring Boot, WebSocket e STOMP
...
- Java + Spring Boot
- WebSocket + STOMP
- HTML, CSS e JavaScript (frontend fornecido)
- STOMP.js

## Objetivo

O principal objetivo deste projeto é aprofundar conhecimentos em comunicação em tempo real, integração entre frontend e backend, e arquitetura de aplicações WebSocket.
